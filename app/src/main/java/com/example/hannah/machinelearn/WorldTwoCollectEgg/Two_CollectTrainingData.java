...
public class Two_CollectTrainingData extends AppCompatActivity implements CollectTrainingData {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.setInstructions(instructions, "Take 5 more photos of your pose to pretend to pick up an egg from the floor.");
