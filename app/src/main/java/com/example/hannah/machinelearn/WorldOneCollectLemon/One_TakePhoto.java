...
public class One_TakePhoto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.setInstructions(takePhotoInstructions,"Take a picture of your partner pretending to collect a lemon from the tree.");
        Utils.setInstructions(takePhotoInstructions2," You're going to need to reach up high! Tap the button below.");
